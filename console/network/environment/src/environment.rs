...
use snarkvm_fields::{PrimeField, SquareRootField, field};
...
impl Environment for Console {
    ...
    const PRECOMPUTED_FIRST_POSEIDON_ROUND: [Self::Field; 9] = [
        field!(
            Fr,
            BigInteger256([
                18400883315055711526u64,
                2190994228000969506u64,
                5206877399204740241u64,
                639223570235065050u64
            ])
        ),
        field!(
            Fr,
            BigInteger256([
                15399590913876696331u64,
                15594399395362219105u64,
                9529204955545525528u64,
                669261489487838935u64
            ])
        ),
        field!(
            Fr,
            BigInteger256([
                6602557572627535518u64,
                9929926631054717162u64,
                4515907751056267905u64,
                663106168251105715u64
            ])
        ),
        field!(
            Fr,
            BigInteger256([
                6993747136410928348u64,
                18065552776694758143u64,
                2408644198368128959u64,
                632536464969372654u64
            ])
        ),
        field!(
            Fr,
            BigInteger256([
                7545327712549990254u64,
                4761540785546221362u64,
                8841461201722074u64,
                1306050386496310916u64
            ])
        ),
        field!(
            Fr,
            BigInteger256([
                18213014258197997104u64,
                13996994921836506268u64,
                17734367086959815498u64,
                683479563726195903u64
            ])
        ),
        field!(
            Fr,
            BigInteger256([
                8891171731444413293u64,
                15005596550599256007u64,
                8255404474136563175u64,
                115883256545935591u64
            ])
        ),
        field!(
            Fr,
            BigInteger256([
                4511196639787990753u64,
                13695034759934762127u64,
                17467001190581089751u64,
                955255359426287200u64
            ])
        ),
        field!(
            Fr,
            BigInteger256([
                9546547704158379798u64,
                16739824303501531796u64,
                16409388477121326005u64,
                440214594306550130u64
            ])
        ),
    ];
}
