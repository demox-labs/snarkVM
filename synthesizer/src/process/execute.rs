...
impl<N: Network> Process<N> {
    ...
    pub fn execute<A: circuit::Aleo<Network = N>, R: Rng + CryptoRng>(
        ...
        use web_sys::console;
        console::log_1(&"Before execute".into());
        ...
        console::log_1(&"Call stack execute 1".into());
        ...
        console::log_1(&"after execute".into());
